      ...
      <div className="relative z-10 w-full max-w-[90rem] mx-auto px-8">
        ...
        >
          ...
          <p className="text-xl text-slate-400 font-light max-w-3xl mx-auto leading-relaxed">
            Real-world analytics solutions that delivered measurable business impact and transformed 
            decision-making processes across healthcare, enterprise, and business intelligence domains.
          </p>
        </motion.div>
